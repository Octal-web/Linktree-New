...
export const InputFileImage = ({ title, name, imagem, size, allowCrop, onImageCrop }) => {
    ...
    const getResizedImg = (imageSrc, extension) => {
        ...
        image.onload = () => {
            ...
            ctx.drawImage(image, 0, 0, Math.round(scaledWidth), Math.round(scaledHeight));
        ...
        <div className="mb-6">
            ...
            <div>
                {showCurrentImage ? (
                    ...
                    <ReactCrop crop={crop} onChange={onCropChange} aspect={size.largura / size.altura} onComplete={onCropComplete}>
                ...
                <div className="flex items-center space-x-2 text-xs text-gray-700 mt-4">
                    ...
                    <span>
                        A imagem deve ter no mínimo <span className="font-bold">{size.largura}px</span> de largura e{' '}
                        <span className="font-bold">{size.altura}px</span> de altura.
                    </span>
                </div>
            </div>
        </div>
