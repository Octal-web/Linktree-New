...
export const InputTipTapEditor = ({ title, name, toolbar = [], value, onChange, max = null }) => {
                ...
                <div className="flex flex-wrap items-center gap-1 p-2 bg-gray-50 border-b">
                    ...
                    {toolbar.includes('Image') && (
                        <>
                            ...
                            {showImageModal && (
                                <ImageUploadModal onImageSelect={handleImageSelect} onClose={() => setShowImageModal(false)} />
                            )}
                            <span className="border-r h-8 ml-1" />
                        </>
                    )}
