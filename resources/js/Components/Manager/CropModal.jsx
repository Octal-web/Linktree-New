...
export const CropModal = ({ closeModal, imageUrl, cropRoute, size = { largura: 800, altura: 600 } }) => {
                    ...
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        <div className="sm:flex sm:items-start">
                            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                <h3 className="text-lg leading-6 font-medium text-gray-900 mb-4">Cortar imagem</h3>
                                <div className="mt-2">
                                    <ReactCrop
                                        crop={crop}
                                    ...
                                    >
                                        <img ref={imageRef} src={imageUrl} onLoad={onImageLoad} className="max-w-full" />
                                    </ReactCrop>
                                </div>
                            </div>
                        </div>
